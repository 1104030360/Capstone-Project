...
Item {
    ...
    ColumnLayout {
        ...
        ComboBox {
            ...
            model: serviceManager.names  // Use serviceManager.names property
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Button {
                                    ...
                                    width: parent.width * 0.25
                                    onClicked: {
                                        adminHome.load_service_media(service_id)
                                        mainContentLoader.source = "../../qml/pages/admin_service_detail_page.qml"
                                    }
                                }
                            }
                        }
