...
Window {
    ...
    Rectangle {
        ...
        Column {
            ...
            Text {
                id: username
                text: serverHome ? serverHome.getAccountName() : ""
                font.pixelSize: 24
                color: "#ffffff"
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        mainContentLoader.source = "../../qml/pages/server_home_button.qml"
                        serverHome.onLoadHome()  // Call the function to reload data
                    }
                }
            }
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Image {
                        id: recordImage
                        source: "../../images/icons/record.png"
                        width: 30
                        height: 30
                        anchors.verticalCenter: parent.verticalCenter
                        anchors.left: parent.left
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        mainContentLoader.source = "../../qml/pages/record_widget.qml"
                    }
                }
            }
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Image {
                        id: analysisImage
                        source: "../../images/icons/analysis.png" 
                        width: 30
                        height: 30
                        anchors.verticalCenter: parent.verticalCenter
                        anchors.left: parent.left
                    ...
                    Text {
                        ...
                        font.bold: true
                        anchors.verticalCenter: parent.verticalCenter
                        anchors.left: analysisImage.right
                        anchors.right: parent.right
                        anchors.leftMargin: 10
                        anchors.rightMargin: 110
                    }
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        serverHome.onLoadHome()  // Call the function to reload data
                        mainContentLoader.source = "../../qml/pages/analysis.qml"
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        mainContentLoader.source = "../../qml/pages/server_service_page.qml"
                    }
                }
            }
            // Reports Page Button
            Rectangle {
                ...
                states: [
                    State {
                        name: "hovered"
                        when: mouseArea7.containsMouse
                        PropertyChanges {
                            target: buttonBackground7
                            color: "#555555"
                        }
                    },
                    State {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        mainContentLoader.source = "../../qml/pages/server_reports_page.qml"
                    }
                }
            }
            // Setting Button
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        mainContentLoader.source = "../../qml/pages/server_setting_button.qml"
                    }
                }
            }           
    ...
    Loader {
        ...
        anchors.bottom: parent.bottom
        anchors.leftMargin: 0
        source: "../../qml/pages/server_home_button.qml" // 初始顯示的內容
        onLoaded: {
