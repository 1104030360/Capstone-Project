...
Page {
        ...
        Row {
            ...
            Column {
                ...
                Button {
                    ...
                    font.pixelSize: 16
                    anchors.horizontalCenter: parent.horizontalCenter
                    onClicked: pdfHandler.open_pdf("example2.pdf")
                }
                ...
                Row {
                    ...
                    Button {
                        text: "Previous Page"
                        onClicked: pdfHandler.previous_page()
                        enabled: currentPage > 1  // 只有在第一页之外才启用
                    }
                    Button {
                        text: "Next Page"
                        onClicked: pdfHandler.next_page()
                        enabled: currentPage < totalPages  // 只有在不是最后一页时启用
                    }
                }
    ...
    Connections {
        ...
        // 更新页码信息
        function onCurrentPageChanged(page, total) {
...
// 这里是 PDF 处理的 JavaScript 代码，假设它在同一目录下的 pdfHandler.js 文件中